...
const SEED = {
  ...
  "calendar": [
   ...
   "articles": [
    {articleId:"a001",category:"Market History & Projections",category_fr:"Histoire des Marchés & Projections",title:"From the Great Depression to the Advent of AI: A Century of Capital Market Crises and What Africa Can Learn",title_fr:"De la Grande Dépression à l'Avènement de l'IA : Un Siècle de Crises des Marchés de Capitaux",excerpt:"The 1929 crash, Bretton Woods collapse, the 1997 Asian contagion, the 2008 GFC, COVID-19, and now the AI disruption cycle have each restructured the global financial architecture in ways that created windows of opportunity for emerging market investors who understood the regime shift.",excerpt_fr:"Le krach de 1929, l'effondrement de Bretton Woods, la contagion asiatique de 1997, la GFC de 2008 et le cycle de disruption par l'IA ont chacun restructuré l'architecture financière mondiale.",date:"2026-03-20",author:"Noe Désiré Ikoué"},
    {articleId:"a002",category:"Quantitative Finance",category_fr:"Finance Quantitative",title:"Machine Learning in Credit Scoring: Beyond FICO in Frontier Markets",title_fr:"Machine Learning dans la Notation de Crédit : Au-Delà de FICO sur les Marchés Frontières",excerpt:"Traditional credit scoring models fail systematically in markets with thin credit bureaus and informal income. We examine how gradient boosting and graph neural networks are rebuilding underwriting from the ground up in West and Central Africa.",excerpt_fr:"Les modèles traditionnels de notation de crédit échouent systématiquement sur les marchés avec des bureaux de crédit peu développés.",date:"2026-03-18",author:"Johan A. Botouli"},
    {articleId:"a003",category:"Commodities",category_fr:"Matières Premières",title:"Livestock as an Asset Class: Pricing, Volatility, and the Chad-Cameroon-Nigeria Corridor",title_fr:"Le Bétail comme Classe d'Actifs : Prix, Volatilité et le Corridor Tchad-Cameroun-Nigeria",excerpt:"Cattle and small ruminants represent one of the most significant stores of value for rural households across the Sahel. We construct the first systematic volatility framework for livestock prices.",excerpt_fr:"Le bétail représente l'une des réserves de valeur les plus importantes pour les ménages ruraux au Sahel.",date:"2026-03-15",author:"Balde Ibrahima"},
    {articleId:"a004",category:"Private Equity",category_fr:"Private Equity",title:"African Private Equity: Vintage 2026 Outlook and the LP Rotation Thesis",title_fr:"Private Equity Africain : Perspectives Millésime 2026 et la Thèse de Rotation des LPs",excerpt:"With global LPs rotating away from China and selectively reducing Latin America exposure, Africa is entering a window of genuine institutional attention. We assess which markets and sectors are best positioned.",excerpt_fr:"Avec les LPs mondiaux se détournant de la Chine, l'Afrique entre dans une fenêtre d'attention institutionnelle réelle.",date:"2026-03-12",author:"Noe Désiré Ikoué"},
    {articleId:"a005",category:"Commodities",category_fr:"Matières Premières",title:"Textile Trade Flows: China Demand, CEMAC Supply, and the Price Gap",title_fr:"Flux du Commerce Textile : Demande Chinoise, Offre CEMAC et l'Écart de Prix",excerpt:"Shifting Chinese procurement patterns for West and Central African textiles are creating pricing dislocations that disciplined physical traders can systematically exploit.",excerpt_fr:"L'évolution des schémas d'approvisionnement chinois pour les textiles d'Afrique Centrale crée des dislocations de prix.",date:"2026-03-08",author:"Balde Ibrahima"},
    {articleId:"a006",category:"Market History & Projections",category_fr:"Histoire des Marchés & Projections",title:"AI and the Future of African Financial Markets: Disruption, Inclusion, and the Infrastructure Gap",title_fr:"L'IA et l'Avenir des Marchés Financiers Africains : Disruption, Inclusion et le Déficit d'Infrastructure",excerpt:"Artificial intelligence is compressing the information asymmetry that has historically made African markets expensive for foreign capital. We model three scenarios for how AI could reshape African capital markets by 2035.",excerpt_fr:"L'intelligence artificielle comprime l'asymétrie d'information qui a historiquement rendu les marchés africains coûteux.",date:"2026-03-05",author:"Johan A. Botouli"},
    {articleId:"a007",category:"Financial Technology",category_fr:"Technologies Financières",title:"Blockchain Settlement and Trade Finance in the CEMAC Corridor",title_fr:"Règlement Blockchain et Financement du Commerce dans le Corridor CEMAC",excerpt:"Cross-border trade finance in Central Africa is slowed by correspondent banking fragmentation. We examine how distributed ledger settlement and tokenised trade instruments are beginning to close the gap.",excerpt_fr:"Le financement du commerce transfrontalier en Afrique Centrale est freiné par la fragmentation bancaire correspondante.",date:"2026-03-01",author:"Johan A. Botouli"},
    {articleId:"a008",category:"Private Credit",category_fr:"Crédit Privé",title:"The Missing Middle: Why African SMEs Remain Structurally Underfinanced",title_fr:"Le Maillon Manquant : Pourquoi les PME Africaines Restent Structurellement Sous-Financées",excerpt:"Companies generating $500K to $10M in annual revenue account for the majority of private sector employment across CEMAC and WAEMU, yet access only 12% of available institutional credit.",excerpt_fr:"Les entreprises générant 500K–10M USD de CA annuel représentent la majorité de l'emploi du secteur privé mais n'accèdent qu'à 12% du crédit institutionnel.",date:"2026-02-28",author:"Noe Désiré Ikoué"},
    {articleId:"a009",category:"Commodities",category_fr:"Matières Premières",title:"Commodity Supply Chain Fragility: Lessons from the 2024 Sahel Drought",title_fr:"Fragilité des Chaînes d'Approvisionnement : Leçons de la Sécheresse du Sahel 2024",excerpt:"The 2024 Sahel drought exposed structural vulnerabilities in West African agricultural supply chains. We analyse cascading failures in grain logistics and livestock mortality rates.",excerpt_fr:"La sécheresse du Sahel 2024 a exposé des vulnérabilités structurelles dans les chaînes d'approvisionnement agricoles.",date:"2026-02-25",author:"Balde Ibrahima"},
    {articleId:"a010",category:"Quantitative Finance",category_fr:"Finance Quantitative",title:"Quantum Computing and Portfolio Optimisation: A Practical Timeline",title_fr:"Informatique Quantique et Optimisation de Portefeuille : Une Feuille de Route Pratique",excerpt:"Quantum processors are beginning to outperform classical solvers on specific portfolio optimisation problems. We map the realistic deployment timeline for frontier market fund managers.",excerpt_fr:"Les processeurs quantiques commencent à surpasser les solveurs classiques sur des problèmes spécifiques.",date:"2026-02-20",author:"Johan A. Botouli"},
  ],
  "real_estate": [
