...
const SEED = {
  ...
  {articleId:"a001",
   en:{title:"From the Great Depression to the Advent of AI: A Century of Capital Market Crises and What Africa Can Learn",category:"Market History & Projections",
       excerpt:"The 1929 crash, Bretton Woods collapse, the 1997 Asian contagion, the 2008 GFC, COVID-19, and now the AI disruption cycle — each crisis restructured the global financial architecture in ways that created windows of opportunity for emerging market investors who understood the regime shift. We trace the through-line and map the implications for African private capital deployment in the 2026–2035 decade."},
   fr:{title:"De la Grande Dépression à l'Avènement de l'IA : Un Siècle de Crises des Marchés de Capitaux et Ce que l'Afrique Peut Apprendre",category:"Histoire des Marchés & Projections",
       excerpt:"Le krach de 1929, l'effondrement de Bretton Woods, la contagion asiatique de 1997, la GFC de 2008, le COVID-19 et maintenant le cycle de disruption par l'IA — chaque crise a restructuré l'architecture financière mondiale en créant des fenêtres d'opportunité pour les investisseurs des marchés émergents."},
  ...
  {articleId:"a005",
   en:{title:"Textile Trade Flows: China Demand, CEMAC Supply, and the Price Gap",category:"Commodities",
       excerpt:"Shifting Chinese procurement patterns for West and Central African textiles are creating pricing dislocations that disciplined physical traders can systematically exploit. We map the current supply-demand imbalance and the specific corridors where margin compression is creating entry points."},
  ...
  {articleId:"a008",
   en:{title:"The Missing Middle: Why African SMEs Remain Structurally Underfinanced",category:"Private Credit",
       excerpt:"Companies generating $500K–$10M in annual revenue, employing 20–200 people, and requiring $500K–$15M in growth capital account for the majority of private sector employment across CEMAC and WAEMU — yet access only 12% of available institutional credit. We quantify the structural causes and the opportunity for patient capital providers."},
  ...
  {articleId:"a013",
   en:{title:"Operational Due Diligence in Markets Without Auditors",category:"Operations",
       excerpt:"Deploying capital into West African mid-market companies where IFRS-compliant audited financials are the exception, not the rule, requires a fundamentally different operational due diligence playbook. We detail the field methodology we have developed across 40+ company assessments."},
  ...
  {articleId:"a016",
   en:{title:"Factor Models for African Private Markets: Building a Proprietary Risk Framework",category:"Quantitative Finance",
       excerpt:"Public market factor models — Fama-French, Carhart, AQR — are built on deep liquid datasets. Applying them to African private equity and credit requires fundamental reconstruction. We outline our proprietary five-factor framework calibrated on CEMAC and WAEMU transaction data."},
