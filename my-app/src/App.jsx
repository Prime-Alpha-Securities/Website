...
const SEED = {
  ...
  "calendar": [
   ...
   "articles": [
    {articleId:"a001",
        en:{title:"From the Great Depression to the Advent of AI: A Century of Capital Market Crises and What Africa Can Learn",category:"Market History & Projections",
       excerpt:"The 1929 crash, Bretton Woods collapse, the 1997 Asian contagion, the 2008 GFC, COVID-19, and now the AI disruption cycle have each restructured the global financial architecture in ways that created windows of opportunity for emerging market investors who understood the regime shift. We trace the through-line and map the implications for African private capital deployment in the 2026–2035 decade."},
      fr:{title:"De la Grande Dépression à l'Avènement de l'IA : Un Siècle de Crises des Marchés de Capitaux et Ce que l'Afrique Peut Apprendre",category:"Histoire des Marchés & Projections",
       excerpt:"Le krach de 1929, l'effondrement de Bretton Woods, la contagion asiatique de 1997, la GFC de 2008, le COVID-19 et maintenant le cycle de disruption par l'IA ont chacun restructuré l'architecture financière mondiale en créant des fenêtres d'opportunité pour les investisseurs des marchés émergents."},
    date:"2026-03-20",author:"Noe Désiré Ikoué"},  
    {articleId:"a002",   
      en:{title:"Machine Learning in Credit Scoring: Beyond FICO in Frontier Markets",category:"Quantitative Finance",
       excerpt:"Traditional credit scoring models fail systematically in markets with thin credit bureaus and informal income. We examine how gradient boosting, graph neural networks, and alternative data sources are rebuilding underwriting from the ground up in West and Central Africa."},
      fr:{title:"Machine Learning dans la Notation de Crédit : Au-Delà de FICO sur les Marchés Frontières",category:"Finance Quantitative",
       excerpt:"Les modèles traditionnels de notation de crédit échouent systématiquement sur les marchés avec des bureaux de crédit peu développés. Nous examinons comment le gradient boosting et les réseaux de neurones graphiques reconstruisent la souscription en Afrique."},
    date:"2026-03-18",author:"Johan A. Botouli"},
    {articleId:"a003",   
      en:{title:"Livestock as an Asset Class: Pricing, Volatility, and the Chad-Cameroon-Nigeria Corridor",category:"Commodities",
       excerpt:"Cattle and small ruminants represent one of the most significant stores of value for rural households across the Sahel. We construct the first systematic volatility framework for livestock prices across the Chad-Cameroon-Nigeria corridor and identify structural arbitrage opportunities."},
   fr:{title:"Le Bétail comme Classe d'Actifs : Prix, Volatilité et le Corridor Tchad-Cameroun-Nigeria",category:"Matières Premières",
       excerpt:"Le bétail représente l'une des réserves de valeur les plus importantes pour les ménages ruraux au Sahel. Nous construisons le premier cadre de volatilité systématique pour les prix du bétail dans le corridor Tchad-Cameroun-Nigeria."},
    date:"2026-03-15",author:"Balde Ibrahima"},    
    {articleId:"a004",  
      en:{title:"African Private Equity: Vintage 2026 Outlook and the LP Rotation Thesis",category:"Private Equity",
       excerpt:"With global LPs rotating away from China and selectively reducing Latin America exposure, Africa is entering a window of genuine institutional attention. We assess which markets, sectors, and deal structures are best positioned to absorb meaningful capital over the next 24 months and which narratives are outrunning the fundamentals."},
      fr:{title:"Private Equity Africain : Perspectives Millésime 2026 et la Thèse de Rotation des LPs",category:"Private Equity",
       excerpt:"Avec les LPs mondiaux se détournant de la Chine, l'Afrique entre dans une fenêtre d'attention institutionnelle réelle. Nous évaluons quels marchés, secteurs et structures de transaction sont les mieux positionnés pour absorber des capitaux significatifs dans les 24 prochains mois."},
    date:"2026-03-12",author:"Noe Désiré Ikoué"},    
    {articleId:"a005",  
      en:{title:"Textile Trade Flows: China Demand, CEMAC Supply, and the Price Gap",category:"Commodities",excerpt:"Shifting Chinese procurement patterns for West and Central African textiles are creating pricing dislocations that disciplined physical traders can systematically exploit. We map the current supply-demand imbalance and the specific corridors where margin compression is creating entry points."},
      fr:{title:"Flux du Commerce Textile : Demande Chinoise, Offre CEMAC et l'Écart de Prix",category:"Matières Premières",
       excerpt:"L'évolution des schémas d'approvisionnement chinois pour les textiles d'Afrique Centrale et de l'Ouest crée des dislocations de prix que les traders physiques disciplinés peuvent exploiter systématiquement."},
    date:"2026-03-08",author:"Balde Ibrahima"},
    {articleId:"a006",
      en:{title:"AI and the Future of African Financial Markets: Disruption, Inclusion, and the Infrastructure Gap",category:"Market History & Projections",
          excerpt:"Artificial intelligence is compressing the information asymmetry that has historically made African markets expensive for foreign capital and opaque for domestic investors. We model three scenarios for how AI-driven credit assessment, automated compliance, and real-time market data infrastructure could reshape African capital markets by 2035 and which scenario we are currently tracking toward."},
      fr:{title:"L'IA et l'Avenir des Marchés Financiers Africains : Disruption, Inclusion et le Déficit d'Infrastructure",category:"Histoire des Marchés & Projections",
          excerpt:"L'intelligence artificielle comprime l'asymétrie d'information qui a historiquement rendu les marchés africains coûteux pour les capitaux étrangers. Nous modélisons trois scénarios pour la façon dont l'IA pourrait remodeler les marchés de capitaux africains d'ici 2035."},
    date:"2026-03-05",author:"Johan A. Botouli"},
    {articleId:"a007",
    en:{title:"Blockchain Settlement and Trade Finance in the CEMAC Corridor",category:"Financial Technology",
        excerpt:"Cross-border trade finance in Central Africa is slowed by correspondent banking fragmentation, manual documentation, and FX settlement risk. We examine how distributed ledger settlement and tokenised trade instruments are beginning to close the gap and what remains unsolved."},
    fr:{title:"Règlement Blockchain et Financement du Commerce dans le Corridor CEMAC",category:"Technologies Financières",
        excerpt:"Le financement du commerce transfrontalier en Afrique Centrale est freiné par la fragmentation bancaire correspondante et le risque de règlement FX. Nous examinons comment le règlement sur registre distribué commence à combler cet écart."},
    date:"2026-03-01",author:"Johan A. Botouli"},
    {articleId:"a008",
    en:{title:"The Missing Middle: Why African SMEs Remain Structurally Underfinanced",category:"Private Credit",
        excerpt:"Companies generating $500K to $10M in annual revenue, employing 20 to 200 people, and requiring $500K to $15M in growth capital account for the majority of private sector employment across CEMAC and WAEMU, yet access only 12% of available institutional credit. We quantify the structural causes and the opportunity for patient capital providers."},
    fr:{title:"Le Maillon Manquant : Pourquoi les PME Africaines Restent Structurellement Sous-Financées",category:"Crédit Privé",
        excerpt:"Les entreprises générant 500K–10M USD de CA annuel représentent la majorité de l'emploi du secteur privé en CEMAC et UEMOA — mais n'accèdent qu'à 12% du crédit institutionnel disponible. Nous quantifions les causes structurelles et l'opportunité pour les fournisseurs de capital patient."},
    date:"2026-02-28",author:"Noe Désiré Ikoué"},
    {articleId:"a009",
    en:{title:"Commodity Supply Chain Fragility: Lessons from the 2024 Sahel Drought",category:"Commodities",
        excerpt:"The 2024 Sahel drought exposed structural vulnerabilities in West African agricultural supply chains that no spreadsheet had priced. We analyse the cascading failures in grain logistics, livestock mortality rates, and what physical commodity traders must build into their risk models going forward."},
    fr:{title:"Fragilité des Chaînes d'Approvisionnement : Leçons de la Sécheresse du Sahel 2024",category:"Matières Premières",
        excerpt:"La sécheresse du Sahel 2024 a exposé des vulnérabilités structurelles dans les chaînes d'approvisionnement agricoles ouest-africaines. Nous analysons les défaillances en cascade dans la logistique céréalière et les taux de mortalité du bétail."},
    date:"2026-02-25",author:"Balde Ibrahima"},
    {articleId:"a010",
    en:{title:"Quantum Computing and Portfolio Optimisation: A Practical Timeline",category:"Quantitative Finance",
        excerpt:"Quantum annealing and gate-based quantum processors are beginning to outperform classical solvers on specific portfolio optimisation problems. We map the realistic deployment timeline for frontier market fund managers and what it means for risk-adjusted return modelling."},
    fr:{title:"Informatique Quantique et Optimisation de Portefeuille : Une Feuille de Route Pratique",category:"Finance Quantitative",
        excerpt:"Les processeurs quantiques commencent à surpasser les solveurs classiques sur des problèmes spécifiques d'optimisation de portefeuille. Nous cartographions le calendrier de déploiement réaliste pour les gestionnaires de fonds sur marchés frontières."},
    date:"2026-02-20",author:"Johan A. Botouli"},
    {articleId:"a011",
    en:{title:"The African Continental Free Trade Area: Capital Flows, Market Integration, and the 2035 Horizon",category:"Market History & Projections",
        excerpt:"The AfCFTA represents the most significant structural shift in African trade architecture since independence. Full implementation would create a $3.4T consumer market with integrated capital flows. We model the realistic implementation timeline, the sectors most likely to see early capital market deepening, and the investment opportunities that arise in the transition period."},
    fr:{title:"La Zone de Libre-Échange Continentale Africaine : Flux de Capitaux, Intégration des Marchés et l'Horizon 2035",category:"Histoire des Marchés & Projections",
        excerpt:"La ZLECAf représente le changement structurel le plus significatif dans l'architecture commerciale africaine depuis l'indépendance. Nous modélisons le calendrier de mise en œuvre réaliste et les opportunités d'investissement qui surgissent dans la période de transition."},
    date:"2026-02-14",author:"Noe Désiré Ikoué"},
    {articleId:"a012",
    en:{title:"Private Credit Spreads in West Africa: Structure, Pricing, and Where Compression Begins",category:"Private Credit",
        excerpt:"Direct lending to West African mid-market companies currently prices at 18 to 28% all-in cost of capital, a spread that reflects genuine risk, institutional scarcity, and information asymmetry in roughly equal measure. We decompose the spread and identify where compression is likely to occur first as the asset class matures."},
    fr:{title:"Spreads de Crédit Privé en Afrique de l'Ouest : Structure, Tarification et Où la Compression Commence",category:"Crédit Privé",
        excerpt:"Le prêt direct aux entreprises du marché intermédiaire en Afrique de l'Ouest est actuellement tarifé à 18–28% de coût de capital all-in. Nous décomposons ce spread et identifions où la compression est susceptible de se produire en premier."},
    date:"2026-02-10",author:"Noe Désiré Ikoué"},
    {articleId:"a013",
    en:{title:"Operational Due Diligence in Markets Without Auditors",category:"Operations",
        excerpt:"Deploying capital into West African mid-market companies where IFRS-compliant audited financials are the exception, not the rule, requires a fundamentally different operational due diligence playbook. We detail the field methodology we have developed across 40 or more company assessments."},
    fr:{title:"Due Diligence Opérationnelle sur des Marchés Sans Auditeurs",category:"Opérations",
        excerpt:"Déployer des capitaux dans des PME ouest-africaines où les états financiers audités conformes aux IFRS sont l'exception exige un manuel de due diligence opérationnelle fondamentalement différent. Nous détaillons la méthodologie terrain développée sur plus de 40 évaluations."},
    date:"2026-01-30",author:"Balde Ibrahima"},
    {articleId:"a014",
    en:{title:"Algorithmic Market Making in Illiquid African Equity Markets",category:"Market Structure",
        excerpt:"The BRVM and NSE present unique microstructure challenges: wide spreads, thin order books, and infrequent price discovery. We analyse how algorithmic liquidity provision can be adapted for African exchanges and what it implies for price efficiency and institutional participation."},
    fr:{title:"Tenue de Marché Algorithmique sur les Marchés Actions Africains Illiquides",category:"Structure de Marché",
        excerpt:"La BRVM et la NSE présentent des défis de microstructure uniques : spreads larges, carnets d'ordres peu profonds et découverte de prix rare. Nous analysons comment la fourniture de liquidité algorithmique peut être adaptée aux bourses africaines."},
    date:"2026-01-22",author:"Johan A. Botouli"},
    {articleId:"a015",
    en:{title:"COVID-19 and African Sovereign Debt: The Restructuring Cycle That Remade the Continent's Borrowing Capacity",category:"Market History & Projections",
        excerpt:"The pandemic-era debt accumulation across Sub-Saharan Africa created a sovereign debt overhang whose resolution is still underway. We analyse the G20 Common Framework's failures, the Zambia and Ghana restructurings, and what the resulting sovereign credit landscape means for private capital providers operating in the same jurisdictions."},
    fr:{title:"COVID-19 et la Dette Souveraine Africaine : Le Cycle de Restructuration qui a Refaçonné la Capacité d'Emprunt du Continent",category:"Histoire des Marchés & Projections",
        excerpt:"L'accumulation de dettes à l'ère pandémique en Afrique subsaharienne a créé un surplomb de dette souveraine dont la résolution est toujours en cours. Nous analysons les échecs du Cadre Commun du G20 et les restructurations de la Zambie et du Ghana."},
    date:"2026-01-15",author:"Noe Désiré Ikoué"},
    {articleId:"a016",
    en:{title:"Factor Models for African Private Markets: Building a Proprietary Risk Framework",category:"Quantitative Finance",
        excerpt:"Public market factor models like Fama-French, Carhart, and AQR are built on deep liquid datasets. Applying them to African private equity and credit requires fundamental reconstruction. We outline our proprietary five-factor framework calibrated on CEMAC and WAEMU transaction data."},
    fr:{title:"Modèles Factoriels pour les Marchés Privés Africains : Construire un Cadre de Risque Propriétaire",category:"Finance Quantitative",
        excerpt:"Les modèles factoriels des marchés publics sont construits sur des données liquides profondes. Leur application au private equity et crédit africains nécessite une reconstruction fondamentale. Nous présentons notre cadre propriétaire à cinq facteurs calibré sur des données CEMAC et UEMOA."},
    date:"2026-01-08",author:"Johan A. Botouli"},
    {articleId:"a017",
    en:{title:"Bretton Woods, Petrodollars, and the Structural Exclusion of African Capital Markets",category:"Market History & Projections",
        excerpt:"The post-war financial architecture was designed by and for the victors of 1945. The dollar's reserve currency status, IMF conditionality, and the CFA franc zone's peg to the French Treasury were not accidents, they were deliberate structural choices whose effects persist in African capital market development today."},
    fr:{title:"Bretton Woods, Pétrodollars et l'Exclusion Structurelle des Marchés de Capitaux Africains",category:"Histoire des Marchés & Projections",
        excerpt:"L'architecture financière d'après-guerre a été conçue par et pour les vainqueurs de 1945. Le statut de monnaie de réserve du dollar, la conditionnalité du FMI et l'arrimage du franc CFA au Trésor français n'étaient pas des accidents — ce sont des choix structurels délibérés dont les effets persistent aujourd'hui."},
    date:"2025-12-15",author:"Noe Désiré Ikoué"},
    {articleId:"a018",
    en:{title:"The 2008 Global Financial Crisis: How Contagion Reached Africa and What It Built",category:"Market History & Projections",
        excerpt:"The 2008 GFC reached African markets later, hit differently, and in several cases accelerated structural reforms that would not have occurred otherwise. We examine the transmission mechanisms, the sovereign debt restructurings that followed, and the private capital ecosystem that emerged from the wreckage."},
    fr:{title:"La Crise Financière Mondiale de 2008 : Comment la Contagion a Atteint l'Afrique et Ce Qu'elle a Construit",category:"Histoire des Marchés & Projections",
        excerpt:"La GFC de 2008 a atteint les marchés africains plus tard, les a touchés différemment et a dans plusieurs cas accéléré des réformes structurelles. Nous examinons les mécanismes de transmission et l'écosystème de capital privé qui a émergé des décombres."},
    date:"2025-12-08",author:"Noe Désiré Ikoué"},
    {articleId:"a019",
    en:{title:"Operational Due Diligence in Markets Without Auditors",category:"Operations",
        excerpt:"Deploying capital into West African mid-market companies where IFRS-compliant audited financials are the exception, not the rule, requires a fundamentally different operational due diligence playbook. We detail the field methodology we have developed across 40 or more company assessments in CEMAC and WAEMU."},
    fr:{title:"Due Diligence Opérationnelle sur des Marchés Sans Auditeurs",category:"Opérations",
        excerpt:"Déployer des capitaux dans des PME ouest-africaines où les états financiers audités conformes aux IFRS sont l'exception exige un manuel de due diligence opérationnelle fondamentalement différent."},
    date:"2025-11-20",author:"Balde Ibrahima"},
  ],
  "real_estate": [
...
function WhoWeAre({sub}){
  ...
  const C={
    ...
    Culture:{
      en:{h:"Our Culture",body:"Culture is not what you say you believe. It is what you do when you are under pressure, short on time, and the right answer is inconvenient. These are the non-negotiables that define how we operate—established before we pressure tested them.",
        pillars:[
      ...
      fr:{h:"Notre Culture",body:"La culture n'est pas ce que vous dites croire. C'est ce que vous faites sous pression, en manque de temps, quand la bonne réponse est inconfortable. Ce sont les non-négociables qui définissent notre façon d'opérer—établis avant que nous les ayons testés.",
        pillars:[
